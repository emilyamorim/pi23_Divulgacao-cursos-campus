...
<i class="bi bi-balloon-fill"></i><br/>Técnico integrado em eventos
  ...
  <div class="modal fade" id="exampleModa2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabe2">O presente documento constitui-se do projeto pedagógico do curso Técnico de Nível Médio em Eventos, na forma Integrada. Este projeto pedagógico de curso se propõe a contextualizar e definir as diretrizes pedagógicas para o referido curso técnico de nível médio no âmbito do Instituto Federal de Educação, Ciência e Tecnologia do Rio Grande do Norte, destinado a estudantes oriundos do ensino fundamental que pretendam ingressar em um curso técnico integrado ao ensino médio. Após a integralização dos componentes curriculares do Curso Técnico de Nível Médio em Eventos, na forma Integrada, presencial, e da realização da correspondente prática profissional, será conferido ao egresso o Diploma de Técnico em Eventos.</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <div class="modal-header">
