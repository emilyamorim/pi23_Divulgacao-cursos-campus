...
<body>
 ...
 <div class="col-lg-6">
   <h2>Áreas</h2>
  <p><a href="p_modalidades_adicionar.php">Adicionar</a></p>
...
if ($result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
    ...
    echo "<td><a href='p_modalidades_editar.php?id=".$row["id"]."'>EDITAR</td>";
    echo "<td><a href='php/bd_modalidades_remover.php?id=".$row["id"]."'>REMOVER</td>";
    echo "</tr>";
  }
} else {
